  ...
  return (
    <>
      ...
      <section className="py-20 bg-[#f9fbfd]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex items-center justify-center space-x-4">
            <Button className="bg-[#00ab80] hover:bg-[#00ab80]/90 text-white px-8 py-3">Book a Discovery Call</Button>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <p className="text-[#7c8b9d] mb-4">Explore Our Product Suite</p>
          ...
          <div className="flex items-center justify-center space-x-4">
            <Button className="bg-[#231f20] hover:bg-[#231f20]/90 text-white">Product Suite</Button>
            <button className="text-[#7c8b9d] hover:text-[#231f20]">Custom team data</button>
            <button className="text-[#7c8b9d] hover:text-[#231f20]">Event search</button>
          </div>
        </div>
      </section>
